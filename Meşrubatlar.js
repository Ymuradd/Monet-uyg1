...
export default function Meşrubatlar({ navigation }) {
  const { addToBasket } = useBasket();
  const initialProducts = [
    { id: '1', name: 'Sprite', description: '', price: '60,00' },
    { id: '2', name: 'Coca Cola', description: '', price: '65,00' },
    { id: '3', name: 'Fuse Tea', description: 'Mango, Şeftali, Limon, Karpuz', price: '60,00' },
    { id: '4', name: 'Redbull', description: '', price: '85,00' },
    { id: '5', name: 'Soda', description: '', price: '40,00' },
    { id: '6', name: 'Limonlu Soda', description: '', price: '45,00' },
    { id: '7', name: 'Su', description: '', price: '25,00' },
    { id: '8', name: 'Cappy', description: 'Vişne, Karışık', price: '60,00' }
  ];

...
export default function SpecialDrinks({ navigation }) {
   const { addToBasket } = useBasket();
  const initialProducts = [
    { id: '1', name: 'Suwde', description: '4 farklı tat notası ile hazırlanan special içecek', price: '130,00' },
    { id: '2', name: 'Lilith Coffee', description: 'Espresso ve file bademin muhteşem uyumu', price: '130,00' }
  ];

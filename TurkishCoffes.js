...
export default function Turkkahveleri({ navigation }) {
   const { addToBasket } = useBasket();
  const initialProducts =[
    { id: '1', name: 'Türk Kahvesi', price: '65,00' },
    { id: '2', name: 'Sütlü Türk Kahvesi', price: '65,00' },
    { id: '3', name: 'Damla Sakızlı Türk Kahvesi', price: '65,00' },
    { id: '4', name: 'Menengiç Kahvesi', price: '65,00' },
    { id: '5', name: 'Dibek Kahvesi', price: '65,00' },
    { id: '6', name: 'Osmanlı Kahvesi', price: '65,00' }
  ];

...
export default function Extralar({ navigation }) {
  const { addToBasket } = useBasket();
  const initialProducts = [
    { id: '1', name: 'Extra Şurup', description: '1 pump çikolata', price: '7,50' },
    { id: '2', name: 'Extra Espresso Shot', description: 'Extra 30 ml Espresso', price: '20,00' },
    { id: '3', name: 'Extra Süt', description: '1 pot süt', price: '15,00' }
  ]
  ;
